export default {
    accounts: {
      ...
      mock: {
        ...
        resultCount: '{count} mock accounts',
      ...
      columns: {
        ...
        adminUsageMultiplier: 'Settlement Multiplier',
      ...
      upstreamBilling: {
        ...
        autoProbeHint: 'Refresh this account\'s upstream declared rate on the global interval. This switch alone does not change the account rate.',
        rateIncreased: 'Upstream rate increased',
        rateDecreased: 'Upstream rate decreased',
        readOnlyPreview: 'The local read-only preview does not probe upstreams or write production data',
        ...
        manualRateInput: 'Upstream Declared Rate',
        manualRateInputPlaceholder: 'Enter a fallback rate for failed probes',
        manualRateInputHint: 'Used only while probing fails. Leave blank to clear it; a successful probe clears it automatically.',
        lastAutomaticRateHint: 'Last automatic rate: {value}x (reference only)',
        manualRate: 'Manually set rate: {value}x',
        manualSource: 'Manual',
      ...
      upstreamSites: {
        ...
        description: 'Manage one shared web login per upstream site domain.',
        search: 'Search site, account name, or login',
        website: 'Website',
        loginUsername: 'Login Username',
        loginPassword: 'Login Password',
        configured: 'Configured',
        notConfigured: 'Not Configured',
        editTitle: 'Edit Upstream Site Account',
        passwordKeepPlaceholder: 'Leave blank to keep the current password',
        passwordHint: 'Passwords are encrypted and never displayed. Leave blank to keep the saved password.',
        saved: 'Upstream site account saved',
        loadFailed: 'Failed to load upstream site accounts',
        saveFailed: 'Failed to save upstream site account',
        readOnlyPreview: 'The local read-only preview does not update production credentials',
        columns: {
          website: 'Website',
