export default {
    settings: {
      ...
      emailTabDisabledTitle: 'Email Security Verification Not Enabled',
      emailTabDisabledHint: 'Enable email security verification in the Security tab to configure SMTP. Account registration is unaffected.',
      registration: {
        ...
        emailVerification: 'Email Security Verification',
        emailVerificationHint: 'Used for password recovery, email binding, and security checks; it does not affect account registration',
