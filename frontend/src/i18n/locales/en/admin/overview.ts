export default {
    ...
    dashboard: {
      ...
      // 补齐经营指标在英文语言环境下的消费文案。
      todayTotalConsumption: '今日总消费',
      last24HourTotalConsumption: '24 小时总消费',
      ...
      rangeRecharge: '充值总额',
      rangeTokens: 'Token 总量',
      rangeConsumption: "消费总额（全部 / 排除 admin{'@'}example.com）",
      rangeAccountCost: '账号成本',
      allAndExcludeAdmin: "全部 / 排除 admin{'@'}example.com",
      businessSummaryLoadFailed: '历史经营数据读取失败，已保留上次成功数据，请点击刷新重试。',
      lowBalanceAccounts: 'Upstream Accounts Below 5',
      noLowBalanceAccounts: 'No low-balance accounts',
      lowBalanceLoadFailed: '低余额账号读取失败，已保留上次成功数据，请点击刷新重试。',
    ...
    users: {
      ...
      form: {
        ...
        adminUsageMultiplierHint: 'Visible to admins only. Final multiplier = base multiplier x this multiplier, with up to 4 decimal places. For example, to change 0.09 to 0.1, enter 1.1111. Affects tokens, costs, and actual billing for new requests; history is unchanged. A user value overrides the group value; leave empty to inherit.',
    ...
    groups: {
      ...
      sortOrder: 'Sort',
      columnSettings: 'Column Settings',
      sortOrderHint: 'Platform order is fixed; drag groups to reorder them within the same platform',
      ...
      form: {
        ...
        rateMultiplier: 'Rate Multiplier',
        adminUsageMultiplier: 'Admin Usage Multiplier',
        adminUsageMultiplierHint: 'Visible to admins only. Final multiplier = base multiplier x this multiplier, with up to 4 decimal places. For example, to change 0.09 to 0.1, enter 1.1111. Affects tokens, costs, and actual billing for new requests; history is unchanged. Defaults to 1; a user-level value takes priority.',
        adminUsageMultiplierInvalid: 'Admin usage multiplier must be a number greater than or equal to 0.',
        status: 'Status',
