export default {
    accounts: {
      ...
      columns: {
        ...
        adminUsageMultiplier: '结算附加倍率',
        upstreamBillingRate: '上游声明倍率',
        upstreamBalance: '上游账号余额',
        weight: '权重',
        schedulerScore: '调度权值',
        status: '状态',
        schedulable: '调度',
      ...
      upstreamBilling: {
        ...
        autoProbeHint: '启用后按全局周期刷新此账号的上游声明倍率；此开关本身不会修改账号倍率。',
        rateIncreased: '上游倍率上涨',
        rateDecreased: '上游倍率下跌',
        readOnlyPreview: '本地只读预览不会探测上游或写入线上数据',
        syncRate: '同步上游声明倍率',
        ...
        manualRateInput: '上游声明倍率',
        manualRateInputPlaceholder: '请输入失败时使用的倍率',
        manualRateInputHint: '仅在探测失败时生效；留空可清除手动值，后续探测成功后会自动清除。',
        lastAutomaticRateHint: '上次自动探测倍率：{value}x（仅供参考）',
        manualRate: '手动设置倍率：{value}x',
        manualSource: '手动',
      ...
      upstreamSites: {
        title: '上游站点账号',
        description: '按官网域名维护网页登录账号，同一站点的多个 API Key 账号共享一套登录凭据。',
        search: '搜索官网、账号名称或登录账号',
        website: '官网地址',
        loginUsername: '登录账号',
        loginPassword: '登录密码',
        configured: '已配置',
        notConfigured: '未配置',
        editTitle: '编辑上游站点账号',
        passwordKeepPlaceholder: '留空保留原密码',
        passwordHint: '密码加密保存且不会回显；已配置时留空不会覆盖原密码。',
        saved: '上游站点账号已保存',
        loadFailed: '加载上游站点账号失败',
        saveFailed: '保存上游站点账号失败',
        readOnlyPreview: '本地只读验收模式不会写入线上凭据',
        columns: {
          website: '官网地址',
          accounts: '关联账号名称',
          protocol: '查询协议',
