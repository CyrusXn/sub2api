export default {
    settings: {
      ...
      emailTabDisabledTitle: '邮件安全验证未启用',
      emailTabDisabledHint: '请在「安全与认证」选项卡中启用邮件安全验证后，再配置 SMTP 设置。账号注册不受此开关影响。',
      registration: {
        title: '注册设置',
        description: '控制用户注册和验证',
        enableRegistration: '开放注册',
        enableRegistrationHint: '允许新用户注册',
        emailVerification: '邮件安全验证',
        emailVerificationHint: '用于找回密码、邮箱绑定和安全验证，不影响账号注册',
