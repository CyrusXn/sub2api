export default {
    ...
    dashboard: {
      ...
      realtimePerformance: '实时性能',
      currentConcurrency: '当前并发',
      todayActiveUsers: '今日活跃',
      last24HourTokens: '24 小时 Token',
      ...
      businessSummaryLoadFailed: '历史经营数据读取失败，请点击卡片右上角刷新重试。',
      lowBalanceAccounts: '上游余额低于 5 元的账号',
      noLowBalanceAccounts: '暂无低余额账号',
      lowBalanceLoadFailed: '低余额账号读取失败，已保留上次成功数据，请点击刷新重试。',
      bandwidthTrend: '带宽流量趋势',
      cpuTrend: 'CPU 占用趋势',
      memoryTrend: '内存占用趋势',
      diskTrend: '硬盘占用趋势',
      networkReceive: '下行',
    ...
    users: {
      ...
      form: {
        ...
        adminUsageMultiplierHint: '配置仅管理端可见；最终倍率 = 原倍率 x 此倍率，支持 4 位小数。例如 0.09 调整为 0.1，应填写 1.1111。影响新请求的 Token、费用和真实扣费，历史不追溯；用户倍率优先，留空继承分组倍率。',
    ...
    groups: {
      ...
      sortOrder: '排序',
      columnSettings: '列设置',
      sortOrderHint: '平台顺序固定，可拖拽调整同平台分组的显示顺序',
      ...
      form: {
        ...
        rateMultiplier: '费率倍数',
        adminUsageMultiplier: '管理统计附加倍率',
        adminUsageMultiplierHint: '配置仅管理端可见；最终倍率 = 原倍率 x 此倍率，支持 4 位小数。例如 0.09 调整为 0.1，应填写 1.1111。影响新请求的 Token、费用和真实扣费，历史不追溯；默认 1，用户单独设置后优先。',
        adminUsageMultiplierInvalid: '管理统计附加倍率必须是大于或等于 0 的数字',
        status: '状态',
        exclusive: '专属分组',
        nameLabel: '分组名称',
