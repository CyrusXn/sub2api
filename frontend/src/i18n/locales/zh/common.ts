export default {
  ...
  auth: {
    ...
    registrationEmailDomainNotAllowed: '仅支持 qq.com 和 163.com 邮箱注册',
    ...
    errors: {
      ...
      REGISTRATION_EMAIL_DOMAIN_NOT_ALLOWED: '仅支持 qq.com 和 163.com 邮箱注册',
    },
    ...
    registrationWechatGroupContactSuffix: '邀请进群并领取试用额度',
