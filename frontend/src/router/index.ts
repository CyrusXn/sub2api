...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: 'Upstream Site Accounts',
      titleKey: 'admin.accounts.upstreamSites.title',
      descriptionKey: 'admin.accounts.upstreamSites.description'
    }
  },
  {
  ...
  {
    path: '/admin/business-history',
    name: 'AdminBusinessHistory',
    component: () => import('@/views/admin/BusinessHistoryView.vue'),
    meta: {
      requiresAuth: true,
      requiresAdmin: true,
      title: '经营历史',
