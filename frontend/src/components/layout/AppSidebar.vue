...
import { UsersIcon, FolderIcon, CreditCardIcon, GlobeIcon, ChartIcon } from '@/components/icons/adminMenuIcons'
...
//
// 条目顺序：密钥 → 模型广场 → AI 生图 → 批量生图 → 用量 → 可用渠道 → 渠道状态 → 订阅/支付 → 兑换/资料。
...
const adminNavItems = computed((): NavItem[] => {
  const baseItems: NavItem[] = [
    ...
    { path: '/admin/mock-accounts', label: t('nav.mockAccounts'), icon: UsersIcon },
