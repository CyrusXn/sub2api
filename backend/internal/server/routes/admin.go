...
func registerBalanceCenterRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	balanceCenter := admin.Group("/balance-center")
	{
		...
		balanceCenter.GET("/recharge-summary", h.Admin.BalanceCenter.RechargeSummary)
		...
		balanceCenter.POST("/automatic-records/sync", h.Admin.BalanceCenter.SyncAutomaticRecords)
		balanceCenter.POST("/liandong/session", h.Admin.BalanceCenter.SaveLiandongSession)
		balanceCenter.POST("/liandong/sync", h.Admin.BalanceCenter.SyncLiandong)
...
func registerDashboardRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	dashboard := admin.Group("/dashboard")
	{
		...
		dashboard.GET("/business-summary", h.Admin.Dashboard.GetBusinessSummary)
		dashboard.GET("/low-balance-accounts", h.Admin.Dashboard.GetLowBalanceAccounts)
		dashboard.GET("/system-metrics-trend", h.Admin.Dashboard.GetSystemMetricsTrend)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/upstream-sites", h.Admin.Account.ListUpstreamSites)
		accounts.PUT("/upstream-sites/credentials", h.Admin.Account.UpsertUpstreamSiteCredential)
		accounts.DELETE("/upstream-sites/:host/credentials", h.Admin.Account.DeleteUpstreamSiteCredential)
