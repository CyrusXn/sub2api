...
var usageLogInsertArgTypes = [...]string{
	...
	"numeric",     // upstream_cost_base
	"numeric",     // upstream_group_rate_multiplier
	"text",        // session_id
...
func prepareUsageLogInsert(log *service.UsageLog) usageLogInsertPrepared {
	...
	return usageLogInsertPrepared{
		...
		args: []any{
			...
			log.UpstreamCostBase,            // upstream_cost_base
			log.UpstreamGroupRateMultiplier, // upstream_group_rate_multiplier
