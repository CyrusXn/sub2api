...
INSERT INTO batch_image_jobs (
    ...
    base_unit_price, group_rate_multiplier, upstream_group_rate_multiplier, account_rate_multiplier,
...
RETURNING `+batchImageJobColumns,
		...
		params.BaseUnitPrice, params.GroupRateMultiplier, params.UpstreamGroupRateMultiplier, params.AccountRateMultiplier,
...
func scanBatchImageJob(row rowScanner) (*service.BatchImageJob, error) {
	...
	var holdAmount, actualCost, upstreamGroupRateMultiplier sql.NullFloat64
	...
	err := row.Scan(
		...
		&job.BaseUnitPrice, &job.GroupRateMultiplier, &upstreamGroupRateMultiplier, &job.AccountRateMultiplier,
	...
	job.UpstreamGroupRateMultiplier = batchImageNullFloat64Ptr(upstreamGroupRateMultiplier)
