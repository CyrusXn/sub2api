...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		upstreamCostBase          sql.NullFloat64
		upstreamGroupRate         sql.NullFloat64
	...
	log := &service.UsageLog{
		...
		UpstreamCostBase:            nullFloat64Ptr(upstreamCostBase),
		UpstreamGroupRateMultiplier: nullFloat64Ptr(upstreamGroupRate),
