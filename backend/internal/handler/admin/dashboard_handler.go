...
func (h *DashboardHandler) GetUsageTrend(c *gin.Context) {
	...
	trend, hit, err := h.getUsageTrendCached(c.Request.Context(), startTime, endTime, granularity, userID, apiKeyID, accountID, groupID, model, requestType, stream, nativeCompactionV2, billingType, upstreamModelMismatch, multiFilters)
	if err != nil {
...
func (h *DashboardHandler) GetModelStats(c *gin.Context) {
	...
	stats, hit, err := h.getModelStatsCached(c.Request.Context(), startTime, endTime, userID, apiKeyID, accountID, groupID, modelSource, requestType, stream, nativeCompactionV2, billingType, upstreamModelMismatch, multiFilters)
	if err != nil {
...
func (h *DashboardHandler) GetGroupStats(c *gin.Context) {
	...
	stats, hit, err := h.getGroupStatsCached(c.Request.Context(), startTime, endTime, userID, apiKeyID, accountID, groupID, requestType, stream, nativeCompactionV2, billingType, upstreamModelMismatch, multiFilters)
	if err != nil {
...
func (h *DashboardHandler) GetUserSpendingRanking(c *gin.Context) {
	...
	cached, hit, err := dashboardUsersRankingCache.GetOrLoad(cacheKey, func() (any, error) {
		ranking, loadErr := h.dashboardService.GetUserSpendingRanking(c.Request.Context(), startTime, endTime, limit)
		if loadErr != nil {
			return nil, loadErr
		}
		return gin.H{
	...
	c.Header("X-Snapshot-Cache", map[bool]string{true: "hit", false: "miss"}[hit])
...
func (h *DashboardHandler) GetBatchUsersUsage(c *gin.Context) {
	...
	cached, hit, err := dashboardBatchUsersUsageCache.GetOrLoad(cacheKey, func() (any, error) {
		stats, loadErr := h.dashboardService.GetBatchUserUsageStats(c.Request.Context(), userIDs, time.Time{}, time.Time{})
		if loadErr != nil {
			return nil, loadErr
		}
...
func (h *DashboardHandler) GetBatchAPIKeysUsage(c *gin.Context) {
	...
	cached, hit, err := dashboardBatchAPIKeysUsageCache.GetOrLoad(cacheKey, func() (any, error) {
		stats, loadErr := h.dashboardService.GetBatchAPIKeyUsageStats(c.Request.Context(), apiKeyIDs, time.Time{}, time.Time{})
		if loadErr != nil {
			return nil, loadErr
		}
		return gin.H{"stats": stats}, nil
