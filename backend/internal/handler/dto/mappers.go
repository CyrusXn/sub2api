...
func UserFromServiceAdmin(u *service.User) *AdminUser {
	...
	return &AdminUser{
		...
		AdminUsageMultiplier: u.AdminUsageMultiplier,
...
func GroupFromServiceAdmin(g *service.Group) *AdminGroup {
	...
	out := &AdminGroup{
		...
		AdminUsageMultiplier:        g.AdminUsageMultiplier,
...
func UsageLogFromServiceAdmin(l *service.UsageLog) *AdminUsageLog {
	...
	return &AdminUsageLog{
		...
		UpstreamCostBase:            l.UpstreamCostBase,
		UpstreamGroupRateMultiplier: l.UpstreamGroupRateMultiplier,
		IPAddress:                   l.IPAddress,
