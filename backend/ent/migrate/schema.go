...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "admin_usage_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "upstream_recharge_scale", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,6)"}},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "upstream_cost_base", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(20,10)"}},
		{Name: "upstream_group_rate_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "admin_usage_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(10,4)"}},
		{Name: "rpm_limit", Type: field.TypeInt, Default: 0},
	}
