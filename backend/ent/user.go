...
func (*User) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case user.FieldBalance, user.FieldFrozenBalance, user.FieldBalanceNotifyThreshold, user.FieldTotalRecharged, user.FieldAdminUsageMultiplier:
	...
	for i := range columns {
		...
		case user.FieldAdminUsageMultiplier:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
				...
				_m.AdminUsageMultiplier = new(float64)
...
func (_m *User) String() string {
	...
	builder.WriteString(", ")
	if v := _m.AdminUsageMultiplier; v != nil {
