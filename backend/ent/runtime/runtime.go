...
func init() {
	...
	// accountDescAdminUsageMultiplier is the schema descriptor for admin_usage_multiplier field.
	...
	// groupDescAdminUsageMultiplier is the schema descriptor for admin_usage_multiplier field.
	groupDescAdminUsageMultiplier := groupFields[3].Descriptor()
	// group.DefaultAdminUsageMultiplier holds the default value on creation for the admin_usage_multiplier field.
	group.DefaultAdminUsageMultiplier = groupDescAdminUsageMultiplier.Default.(float64)
