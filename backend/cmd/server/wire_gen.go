...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	modelFactoryService := service.NewModelFactoryService(accountRepository)
	modelFactoryHandler := handler.NewModelFactoryHandler(modelFactoryService, apiKeyService)
