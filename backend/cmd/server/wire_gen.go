...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	upstreamBillingProbeService := service.ProvideUpstreamBillingProbeService(accountRepository, accountTestService, settingService, upstreamSiteCredentialService, balanceCenterEventService, balanceCenterRepository, leaderLockCache, db)
